...
def plot_genre_barchart(meta_data):
    ...
    genres_to_compare=[]
    for i in range(0,int(num_of_genres)):
        input_valid = False
        ...
        genre_counts = meta_data[meta_data['track_genre'].isin(genres_to_compare)]['track_genre'].value_counts() #thank you chatGPT
